...
const useGetProducts = ({ limit, searchProduct, inputData }) => {
  ...
  const endpoint = `product/company/${companyId}/getall-no_img/page/${page}/limit/${limit}/${inputData?.brand_selected}/${inputData?.category_selected}/${inputData?.subcategory_selected}`;
